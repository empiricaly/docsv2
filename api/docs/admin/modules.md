...
Defined in: [lib/@empirica/core/src/admin/context.ts:55](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/context.ts#L55)
...
Defined in: [lib/@empirica/core/src/admin/participants.ts:7](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/participants.ts#L7)

##### identifier

> **identifier**: `string`

Defined in: [lib/@empirica/core/src/admin/participants.ts:8](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/participants.ts#L8)
...
Defined in: [lib/@empirica/core/src/admin/transitions.ts:8](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/transitions.ts#L8)

##### endedAt

> `optional` **endedAt**: `number`

Defined in: [lib/@empirica/core/src/admin/transitions.ts:10](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/transitions.ts#L10)

##### id

> **id**: `string`

Defined in: [lib/@empirica/core/src/admin/transitions.ts:6](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/transitions.ts#L6)

##### startedAt

> `optional` **startedAt**: `number`

Defined in: [lib/@empirica/core/src/admin/transitions.ts:9](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/transitions.ts#L9)

##### state

> **state**: `State`

Defined in: [lib/@empirica/core/src/admin/transitions.ts:7](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/transitions.ts#L7)
...
Defined in: [lib/@empirica/core/src/admin/subscriptions.ts:26](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/subscriptions.ts#L26)

##### scopes

> **scopes**: `object`

Defined in: [lib/@empirica/core/src/admin/subscriptions.ts:27](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/subscriptions.ts#L27)
...
Defined in: [lib/@empirica/core/src/admin/subscriptions.ts:34](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/subscriptions.ts#L34)
...
Defined in: [lib/@empirica/core/src/admin/events.ts:14](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/events.ts#L14)
...
Defined in: [lib/@empirica/core/src/admin/participants.ts:21](https://github.com/empiricaly/empirica/blob/5467a49/lib/@empirica/core/src/admin/participants.ts#L21)
