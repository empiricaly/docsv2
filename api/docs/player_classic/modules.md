...
Defined in: [lib/@empirica/core/src/player/provider.ts:25](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L25)
...
Defined in: [lib/@empirica/core/src/player/provider.ts:20](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L20)

##### dones

> **dones**: `Subject`\<`string`[]\>

Defined in: [lib/@empirica/core/src/player/provider.ts:23](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L23)

##### globals

> `readonly` **globals**: `Observable`\<`SubAttributesPayload`\>

Defined in: [lib/@empirica/core/src/player/provider.ts:27](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L27)

##### participants

> **participants**: `Subject`\<[`ParticipantUpdate`](modules.md#participantupdate)\>

Defined in: [lib/@empirica/core/src/player/provider.ts:21](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L21)

##### scopes

> **scopes**: `Subject`\<[`ScopeUpdate`](modules.md#scopeupdate)\>

Defined in: [lib/@empirica/core/src/player/provider.ts:19](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L19)

##### setAttributes

> `readonly` **setAttributes**: `Function`

Defined in: [lib/@empirica/core/src/player/provider.ts:28](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L28)
...
Defined in: [lib/@empirica/core/src/player/provider.ts:22](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L22)
...
Defined in: [lib/@empirica/core/src/player/provider.ts:14](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L14)

##### removed

> **removed**: `boolean`

Defined in: [lib/@empirica/core/src/player/provider.ts:15](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/provider.ts#L15)
...
> **EmpiricaClassicContext**: `object`

Defined in: [lib/@empirica/core/src/player/classic/classic.ts:119](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/classic/classic.ts#L119)

#### Type declaration

> **game**: `BehaviorSubject`\<[`Game`](modules.md#game) \| `null` \| `undefined`\>
>
> **globals**: `BehaviorSubject`\<[`Globals`](modules.md#globals) \| `undefined`\>
>
> **player**: `BehaviorSubject`\<[`Player`](modules.md#player) \| `null` \| `undefined`\>
>
> **players**: `BehaviorSubject`\<[`Player`](modules.md#player)[] \| `undefined`\>
>
> **round**: `BehaviorSubject`\<[`Round`](modules.md#round) \| `null` \| `undefined`\>
>
> **stage**: `BehaviorSubject`\<[`Stage`](modules.md#stage) \| `null` \| `undefined`\>
...
Defined in: [lib/@empirica/core/src/player/steps.ts:81](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/steps.ts#L81)
...
Defined in: [lib/@empirica/core/src/player/utils.ts:1](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/utils.ts#L1)
...
Defined in: [lib/@empirica/core/src/player/utils.ts:2](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/utils.ts#L2)
...
Defined in: [lib/@empirica/core/src/player/utils.ts:3](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/utils.ts#L3)
...
> **EmpiricaClassic**(participantID: `string`, provider: [`TajribaProvider`](modules.md#tajribaprovider)): [`EmpiricaClassicContext`](modules.md#empiricaclassiccontext)

Defined in: [lib/@empirica/core/src/player/classic/classic.ts:128](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/classic/classic.ts#L128)
...
Defined in: [lib/@empirica/core/src/player/utils.ts:5](https://github.com/empiricaly/empirica/blob/d1b58d0/lib/@empirica/core/src/player/utils.ts#L5)
